...
const load = (app: PIXI.Application) => {
    return new Promise<void>((resolve) => {
        app.loader
        .add('base', 'https://raw.githubusercontent.com/jenna5376/acc-hw/main/midterm/assets/base.png')
        .add('socks', 'https://raw.githubusercontent.com/jenna5376/acc-hw/main/midterm/assets/socks.png')
        .add('legWarmers', 'https://raw.githubusercontent.com/jenna5376/acc-hw/main/midterm/assets/legWarmers.png')
        .add('converse', 'https://raw.githubusercontent.com/jenna5376/acc-hw/main/midterm/assets/converse.png')
        .add('dunks', 'https://raw.githubusercontent.com/jenna5376/acc-hw/main/midterm/assets/dunks.png')
        .add('boots', 'https://raw.githubusercontent.com/jenna5376/acc-hw/main/midterm/assets/boots.png')
        .add('skirt', 'https://raw.githubusercontent.com/jenna5376/acc-hw/main/midterm/assets/skirt.png')
        .add('blackPants', 'https://raw.githubusercontent.com/jenna5376/acc-hw/main/midterm/assets/blackPants.png')
        .add('brownPants', 'https://raw.githubusercontent.com/jenna5376/acc-hw/main/midterm/assets/brownPants.png')
        .add('whiteTN', 'https://raw.githubusercontent.com/jenna5376/acc-hw/main/midterm/assets/whiteTN.png')
        .add('hoodie', 'https://raw.githubusercontent.com/jenna5376/acc-hw/main/midterm/assets/hoodie.png')
        .add('sweater', 'https://raw.githubusercontent.com/jenna5376/acc-hw/main/midterm/assets/sweater.png')
        .add('mask', 'https://raw.githubusercontent.com/jenna5376/acc-hw/main/midterm/assets/mask.png')
        .add('hairDown', 'https://raw.githubusercontent.com/jenna5376/acc-hw/main/midterm/assets/hairDown.png')
        .add('bun', 'https://raw.githubusercontent.com/jenna5376/acc-hw/main/midterm/assets/bun.png')
        .add('braid', 'https://raw.githubusercontent.com/jenna5376/acc-hw/main/midterm/assets/braid.png')
        .add('accessoriesIcon', 'https://raw.githubusercontent.com/jenna5376/acc-hw/main/midterm/assets/accessoriesIcon.png')
        .add('bottomIcon', 'https://raw.githubusercontent.com/jenna5376/acc-hw/main/midterm/assets/bottomIcon.png')
        .add('topIcon', 'https://raw.githubusercontent.com/jenna5376/acc-hw/main/midterm/assets/topIcon.png')
        .add('hairIcon', 'https://raw.githubusercontent.com/jenna5376/acc-hw/main/midterm/assets/hairIcon.png')
        .add('shoeIcon', 'https://raw.githubusercontent.com/jenna5376/acc-hw/main/midterm/assets/shoeIcon.png')
        .load(() => {
          resolve();
        });
    });
